...
\section{Projects}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Leveraged \textbf{Win32 APIs} to \textbf{enumerate active threads} and retrieve metadata with low overhead.}
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Designed a simplified tensor processing unit supporting \textbf{2-by-2 matrix multiplication}; submitted to \textbf{Tiny Tapeout} project for manufacturing.}
        \resumeItem{Implemented an on-chip store with \textbf{Verilog} to hold input and weight matrices, enabling continuous data streaming at \textbf{$\sim$99.8 MOP/s}.}
        \resumeItem{Verified designs with \textbf{Python}/\textbf{cocotb} and performed static timing analysis with \textbf{OpenSTA}, ensuring functional correctness.}
    \resumeItemListEnd
    \resumeSubHeadingListEnd
