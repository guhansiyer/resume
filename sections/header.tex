...
\begin{center}
    ...
    \href{mailto:g2iyer@uwaterloo.ca}{\raisebox{-0.2\height}{\faEnvelope[regular]}\ \uline{guhan.iyer@uwaterloo.ca}} {$\mid$}
    % \href{mailto:4guhaniyer@gmail.com}{\raisebox{-0.2\height}{\faEnvelope[regular]}\ \underline{4guhaniyer@gmail.com}} {$\mid$}
    \href{https://linkedin.com/in/guhansiyer/}{\raisebox{-0.2\height}\faLinkedin\ \uline{guhansiyer}} {$\mid$} 
    \href{https://github.com/guhansiyer}{\raisebox{-0.2\height}\faGithub\ \uline{guhansiyer}}
\end{center}
